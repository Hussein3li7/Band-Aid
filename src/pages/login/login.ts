...
export class LoginPage {
  ...
  constructor(private googlePlus: GooglePlus, public alertCtrl: AlertController, public navCtrl: NavController, public navParams: NavParams, public auth: AngularFireAuth, public db: AngularFireDatabase, private fb: Facebook, private spinnerDialog: SpinnerDialog, public apiAuth: ApiServiseProvider) {
